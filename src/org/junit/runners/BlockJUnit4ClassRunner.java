...
public class BlockJUnit4ClassRunner extends ParentRunner<FrameworkMethod>
{
	 ...
	 * only if the previous step threw an exception of the correct type, and throw an exception otherwise.
	 * <li>HOWEVER, if {@code method}'s {@code @Test} annotation has the {@code timeout} attribute, throw an exception
	 * if the previous step takes more than the specified number of milliseconds.
	 ...
	 * <li>ALWAYS run all non-overridden {@code @Before} methods on this class and superclasses before any of the
	 * previous steps; if any throws an Exception, stop execution and pass the exception on.
	 * <li>ALWAYS run all non-overridden {@code @After} methods on this class and superclasses after any of the previous
	 * steps; all After methods are always executed: exceptions thrown by previous steps are combined, if necessary,
	 * with exceptions from After methods into a {@link MultipleFailureException}.
	 * </ul>
	 * 
	 ...
	 * has the {@code expecting} attribute, return normally only if {@code next} throws an exception of the correct
	...
	/**
	 * Returns a {@link Statement}: if {@code method}'s {@code @Test} annotation
	 * has the {@code timeout} attribute, throw an exception if {@code next} takes more than the specified number of
	 * milliseconds.
	 * 
	 * @deprecated Will be private soon: use Rules instead
	 */
	 ...
	 * running {@code next}; all
	 * After methods are always executed: exceptions thrown by previous steps
	 * are combined, if necessary, with exceptions from After methods into a {@link MultipleFailureException}.
	 * 
	 * @deprecated Will be private soon: use Rules instead
	 */
	@Deprecated
